...
links:
  - name: Web Link
        # 这里替换成IEEE网站的链接
    url: chrome-extension://kdpelmjpfafjppnhbloffcjpeomlnpah/https://www.jmlr.org/papers/volume12/ren11a/ren11a.pdf
        #这里替换成文件夹中pdf的相对路径 应为'./xxxxx.pdf' 注意引号和反斜杠
url_pdf: './2011-Lu Ren-Logistic Stick-Breaking Process.pdf'
# 都留空
url_code: ''
url_dataset: ''
url_poster: ''
