...
title: 'Joint Adaptive Target Detection, Position Determination, and Velocity Estimation With a Long Baseline Radar Network'
...
links:
  - name: Web Link
        # 这里替换成IEEE网站的链接!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    url: https://ieeexplore.ieee.org/abstract/document/10794557
        #这里替换成文件夹中pdf的相对路径 应为'./xxxxx.pdf' 注意引号和反斜杠
  - name: Public codes
    url: https://github.com/LiYiming98/UTM-YOLOX
url_pdf: './2024-zhangshiyu-joint adaptive.pdf'
# 都留空
url_code: ''
url_dataset: ''
url_poster: ''
