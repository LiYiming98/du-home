---
title: "A New Feature Extraction Method Based on Micro-Doppler Signature of Ground Moving Targets"
...
links:
  - name: Web Link
        # 这里替换成IEEE网站的链接
    url: https://ieeexplore.ieee.org/document/10028276
        #这里替换成文件夹中pdf的相对路径 应为'./xxxxx.pdf' 注意引号和反斜杠
url_pdf: './2021-renke-a new feature extraction.pdf'
# 都留空
url_code: ''
url_dataset: ''
url_poster: ''
