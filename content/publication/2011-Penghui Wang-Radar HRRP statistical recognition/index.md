...
title: Radar HRRP statistical recognition with temporal factor analysis by automatic Bayesian Ying-Yang harmony learning
...
# 期刊/会议名称 （替换单引号内的XXX）
publication: 'Frontiers of Electrical and Electronic Engineering in China'
...
links:
  - name: Web Link
        # 这里替换成IEEE网站的链接
    url: https://link.springer.com/article/10.1007/s11460-011-0149-8
        #这里替换成文件夹中pdf的相对路径 应为'./xxxxx.pdf' 注意引号和反斜杠
url_pdf: './2011-Penghui Wang-Radar HRRP statistical recognition.pdf'
# 都留空
url_code: ''
url_dataset: ''
url_poster: ''
